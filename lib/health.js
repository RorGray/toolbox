...
// page rather than the tool itself. We therefore define "up" as *reachable*:
// any HTTP response at all (200, 302 -> Authentik, 401, 403, ...) counts as up.
// Only a connection failure, DNS failure, or timeout counts as down.
